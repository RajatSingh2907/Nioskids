  ...
  return (
    <>
      ...
      <main className="trust-page gallery-page">
        <Hero
          id="gallery"
          eyebrow="Memory Meadow"
          eyebrowIcon={<Images className="size-4" aria-hidden />}
          title="Every Learning Moment Becomes A Little Story"
          copy="Step into a warm evidence wall where reading circles, projects, creative work and parent reviews feel less like records and more like memories children are proud to revisit."
          primaryAction={{ href: "#gallery-wall", label: "Explore Moments", icon: <ArrowRight className="size-5" aria-hidden /> }}
          secondaryAction={{ href: "/learning-journey", label: "See The Journey" }}
        />
