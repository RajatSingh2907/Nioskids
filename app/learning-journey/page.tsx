  ...
  return (
    <>
      ...
      <main className="trust-page journey-page">
        <Hero id="learning-journey" title="Every Student Needs A Path They Can Trust" copy="Our journey turns flexible learning into a visible roadmap: discover the learner, create a plan, practice consistently, review progress and prepare for the next milestone." imageSrc="/NiosImages/image%202.png" imageAlt="Students sitting in a circle and writing together during a guided learning activity" primaryAction={{ href: "/contact", label: "Create My Roadmap", icon: <ArrowRight className="size-5" aria-hidden /> }} secondaryAction={{ href: "/programs", label: "Compare Class Paths" }} />
