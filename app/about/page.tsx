  ...
  return (
    <>
      ...
      <main className="trust-page about-page">
        <Hero id="about" eyebrow="About NIOS Kids" eyebrowIcon={<Sparkles className="size-4" aria-hidden />} title="Flexible Learning Should Feel Clear, Kind And Joyful" copy="NIOS Kids is built for families who want child-friendly learning support without losing structure. We combine creative lessons, mentoring and parent guidance so flexible education feels confident instead of confusing." primaryAction={{ href: "/programs", label: "Explore Programs", icon: <ArrowRight className="size-5" aria-hidden /> }} secondaryAction={{ href: "/contact", label: "Talk To A Counsellor" }} />
