  ...
  return (
    <>
      ...
      <main className="nios-info-page">
        <Hero
          id="nios-info"
          eyebrow="Parent clarity guide"
          eyebrowIcon={<Sparkles className="size-4" aria-hidden />}
          title="NIOS Questions Parents Ask First"
          copy="A simple, friendly guide to OBE, Secondary, Senior Secondary, documents, TMA support, practical readiness and what a learning-support platform can help with."
          primaryAction={{ href: siteContact.whatsapp, label: "Ask on WhatsApp", icon: <ArrowRight className="size-5" aria-hidden /> }}
          secondaryAction={{ href: `tel:${siteContact.phone.replace(/\s/g, "")}`, label: "Call Counselling", icon: <Phone className="size-5" aria-hidden /> }}
        />
